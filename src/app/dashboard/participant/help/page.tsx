        ...
        <main className="p-6 md:p-10 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-all group">
              ...
              <p className="text-slate-500 text-sm font-medium leading-relaxed">Chat with our support officers in real-time during working hours when  there is emergency case .</p>
            </div>
            <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-all group">
            ...
            <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm hover:shadow-md transition-all group">
              ...
              <p className="text-slate-500 text-sm font-medium leading-relaxed">Send us an email at info@igirerwanda.org for documentation 
            </div>
          </div>
