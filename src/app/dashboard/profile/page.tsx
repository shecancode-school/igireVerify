...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#F5F5F5] flex">
        <Sidebar />
        <div className="flex-1 w-full md:ml-24 lg:ml-[120px] pb-24 md:pb-0 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] flex flex-col-reverse md:flex-row">
      <Sidebar />
      <div className="flex-1 w-full md:ml-24 lg:ml-[120px] pb-24 md:pb-0">
        <TopBar />
